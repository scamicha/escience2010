...
The rest of this paper is arranged as follows: \S\ref{sec:history} contains a brief history of digital imaging in astronomy and the reduction and analysis of those images. In \S\ref{sec:current} we describe the current paradigm employed by astronomers for dealing with imaging data. We outline some upcoming problems with this paradigm in light of current state-of-the-art imagers and planned imagers of the near future in \S\ref{sec:problem}. We detail a new paradigm for the processing of astronomical images in \S\ref{sec:rev}. In \S\ref{sec:ODI} we describe how this new paradigm can apply to the ODI instrument. Finally, in \S\ref{sec:future} we explore possible future directions and in \S\ref{sec:conclusions} we present our final conclusions.
...
\section{Some Problems with the Current Paradigm}\label{sec:problem}
...
The ODI instrument will be installed on the 3.5 meter telescope at the WIYN observatory on Kitt Peak. Once raw data is collected by the instrument 
